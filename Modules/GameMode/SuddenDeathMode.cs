...
namespace TownOfHost.Modules
{
    public static class SuddenDeathMode
    {
        ...
        public static void CreateOption()
        {
            ...
            SuddenKillcooltime = FloatOptionItem.Create(101015, "SuddenKillcooltime", RoleBase.OptionBaseCoolTime, 15f, TabGroup.MainSettings, false).SetZeroNotation(OptionZeroNotation.Hyphen).SetParent(SuddenDeathModeActive).SetValueFormat(OptionFormat.Seconds);
