...
namespace TownOfHost.Roles.AddOns.Common
{
    public static class MagicHand
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            KillDistance = StringOptionItem.Create(Id + 9, "KillRenge", EnumHelper.GetAllNames<OverrideKilldistance.KillDistance>(), 0, TabGroup.Addons, false).SetParent(CustomRoleSpawnChances[CustomRoles.MagicHand]);
